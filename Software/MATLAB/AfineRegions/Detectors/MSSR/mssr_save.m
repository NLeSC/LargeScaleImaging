...
%**************************************************************************
% mssr_save(features_fname, regions_fname, num_regions, features, ...
%                                                           saliency_masks)
%
...
% OUTPUTS:
%**************************************************************************
% NOTES: usually is executed after mssr.m
%**************************************************************************
% EXAMPLES USAGE: 
% see scrpits (for example mssr_detector_one.m)
%**************************************************************************
% REFERENCES:
%**************************************************************************
function mssr_save(features_fname, regions_fname, num_regions, features, ...
                                                           saliency_masks)
...
if isempty(i)
    ...
    j=i(end);
    features_type_fname = [features_fname(1:i-1) '_type.mssr'];
end
%**************************************************************************
% initialisations
%--------------------------------------------------------------------------
