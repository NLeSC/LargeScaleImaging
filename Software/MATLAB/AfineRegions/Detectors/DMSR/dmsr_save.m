...
%**************************************************************************
% dmsr_save(features_fname, regions_fname, num_regions, features, ...
%                                                           saliency_masks)
%
...
% REFERENCES:
%**************************************************************************
function dmsr_save(features_fname, regions_fname, num_regions, features, ...
                                                           saliency_masks)
...
%--------------------------------------------------------------------------
if nargin < 5
    error('dmsr_save.m requires 5 input arguments!');
end
%**************************************************************************
...
%    j=i(end);
    features_type_fname = [features_fname(1:i-1) '_type.dmsr'];
end
%**************************************************************************
% initialisations
%--------------------------------------------------------------------------
