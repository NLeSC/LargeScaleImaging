% visualize_smssr.m- visualize theS MSSR regions from a single image
%                   overlayed on the original image
%**************************************************************************
% visualize_smssr(image_data, saliency_masks, saliency_type, ...
%                                       region_params)
%
...
function visualize_smssr(image_data, saliency_masks,  ...
