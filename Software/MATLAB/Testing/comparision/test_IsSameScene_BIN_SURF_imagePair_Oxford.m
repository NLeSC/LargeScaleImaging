...
disp('******************************************************************************************************');
disp(' Demo: are 2 images from the Oxford dataset of the same scene (smart binarization + SURF descriptor)?');
disp('******************************************************************************************************');
...
[is_same, num_matches, mean_cost, transf_sim] = IsSameScene_BIN_SURF(im1, im2,...
    bw1, bw2, cc_params, match_params, vis_params, exec_params);
