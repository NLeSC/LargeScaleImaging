...
if filtering
    ...
    [SMI_descr_o,SMI_descr_o_struct] = bwSMIdescriptor(bw_o_f, conn, list_props, ...
        order, coeff_file, max_num_moments);
else
    [SMI_descr_o,SMI_descr_o_struct] = bwSMIdescriptor(bw_o, conn, list_props, ...
        order, coeff_file, max_num_moments);
end
...
for h = trans_deg
    ...
    if filtering
        [SMI_descr_a,SMI_descr_a_struct] = bwSMIdescriptor(bw_a_f, conn, list_props, ...
            order, coeff_file, max_num_moments);
    else
        [SMI_descr_a,SMI_descr_a_struct] = bwSMIdescriptor(bw_a, conn, list_props, ...
            order, coeff_file, max_num_moments);
    end
