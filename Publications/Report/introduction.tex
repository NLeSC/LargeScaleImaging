...
The CV researchers can benefit most from the \nameref{sec:pubs} for overview of current research trends,\nameref{sec:soft} and \nameref{sec:db} for development and testing sections.
The engineers can start by looking at section \nameref{sec:soft}.
Readers interested in the application and directions of NLeSC are referred to sections \nameref{sec:app} and \nameref{sec:conc}.
