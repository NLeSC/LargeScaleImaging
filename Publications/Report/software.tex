...
The saliency detection, salient regions detection and matching, (pre-trained) CNN architectures and large scale CV frameworks, developed by the researchers are often made available to the community. References to the research which led to the  development of the software, can be found in the corresponding parts of Section \fullref{sec:pubs}.
