...
\end{minipage}
 ...
 %\vspace{-0.5cm}
\caption{Binarization of two images of the 'Leuven' sequence (lighting). Left: base image, right: forth image;   top row: gray scale; middlerow: Otsu binarization, bottom row: proposed binarization.}
...
\hfill
\vspace{-0.4cm}
\caption{MSER detection on two images of the tail of the same humpback whale. }
...
\hfill
\vspace{-0.4cm}
\caption{DMSRA detection on two images of the tail of the same humpback whale. }
...
\begin{minipage}[b]{.45\linewidth}
  \centering
  \centerline{\includegraphics[width=3cm]{mserLeatherbackA}}
  % \centerline{(a)}\medskip
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\linewidth}
  \centering
  \centerline{\includegraphics[width=3cm]{mserLeatherbackB}}
%\centerline{(b)}\medskip
\end{minipage}
\hfill
\begin{minipage}[b]{.45\linewidth}
  \centering
  \centerline{\includegraphics[width=3cm]{dmsrLeatherbackA}}
%\centerline{(c)}\medskip
\end{minipage}
\hfill
\begin{minipage}[b]{0.45\linewidth}
  \centering
  \centerline{\includegraphics[width=3cm]{dmsrLeatherbackB}}
% \centerline{(d)}\medskip
\end{minipage}
 \vspace{-0.2cm} 
\caption{Region detection on two images of the pineal spot of the same leatherback turtle.
Top: MSER, bottom: DMSR.}
\label{fig:turtle}
 \vspace{-0.2cm}
\end{figure}
\end{comment}
...
\begin{minipage}[b]{.99\linewidth}
  \centering
  \centerline{\includegraphics[width=8cm]{mserWood}}
  % \vspace{0.2cm}
 % \centerline{(a) MSER}\medskip
\end{minipage}
\hfill
\begin{minipage}[b]{0.99\linewidth}
  \centering
  \centerline{\includegraphics[width=8cm]{dmsrWood}}
 % \vspace{0.2cm}
 % \centerline{(b) DMSR}\medskip
\end{minipage}
%\vspace{-0.25cm}
\caption{Salient region detectors on microscopy wood images. Top: MSER (every second region is shown), bottom: proposed detector, DMSR}
\label{fig:wood}
%
\end{figure}
\vspace{-0.4cm}
