\message{ !name(icip2016_intro_edited.tex)}% The ICIP2016 paper according to the given template
...
\message{ !name(icip2016_intro_edited.tex) !offset(-3) }
...
\message{ !name(icip2016_intro_edited.tex) !offset(-467) }
